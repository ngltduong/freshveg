...
const Categories = () => {
    ...
    const createCategory = async () => {
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Authorization is not valid'}})
        
        if(!name) return dispatch({type: 'NOTIFY', payload: {error: 'Name can not left blank.'}})
                    ...
                    <div key={category._id} className="card my-2 text-capitalize">
                        <div className="card-body d-flex justify-content-between">
                            ...
                            <div style={{cursor: 'pointer'}}>
                                <i className="fas fa-edit me-2 text-info"
