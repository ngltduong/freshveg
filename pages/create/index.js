...
const ProductsManager = () => {
    ...
    // const slugGetFromQuery = router.query.slug
    ...
    const handleSubmit = async(e) => {
        ...
        // let res
        // if(onEdit){
        //     res = await putData(`product/item/${slug}`, {...product, slug, images: [...imgOldURL, ...media]}, auth.token)
        //     if(res.err) return dispatch({type: 'NOTIFY', payload: {error: res.err}})
        // }else{
        const res = await postData('product', {...product, slug, images: [...imgOldURL, ...media]}, auth.token)
        if(res.err) return dispatch({type: 'NOTIFY', payload: {error: res.err}})
        // }
    ...
    //     if(slugGetFromQuery){
    //         setOnEdit(true)
    //         getData(`product/item/${slugGetFromQuery}`).then(res => {
