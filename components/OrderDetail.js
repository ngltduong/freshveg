        ...
        <>
                {
                    ...
                    >
                        <div className="col text-uppercase my-3" style={{maxWidth: '600px'}}>
                            <h2 className="text-break">Order {order._id}</h2>
                            <div className="mt-4 text-secondary">
                                <h3>Shipping</h3>
                                <p>Fullname: {order.user.fullname}</p>
                                    ...
                                    order.cart.map(item => (
                                        ...
                                        >
                                            <div className="col">
                                                ...
                                                />
                                                <h5 className="flex-fill text-secondary px-3 m-0 d-inline-block"
